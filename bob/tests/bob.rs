...
//------ hyphen - "Whatever."
// Last char is `?`(escape empty spaces) and Uppercase and no "OK"- "Calm down, I know what I'm doing!"
// Last char is `?` - "Sure."
// Uppercase - "Whoa, chill out!" (2 consecutive chars)
// Last char is `!` - "Whatever."
// Last char is `.` - "Whatever."
// Last char is not ?`` - "Whatever."
// Only Empty or spaces (escape characters) - "Fine. Be that way!"
//
#[test]

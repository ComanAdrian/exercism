...
tests! {
    test_classification {
        ...
        test_6(6, Classification::Perfect); // #[ignore] test_6(6, Classification::Perfect);
        test_12(12, Classification::Abundant); // #[ignore]
        test_28(28, Classification::Perfect); // #[ignore]
        test_30(30, Classification::Abundant); // #[ignore]
